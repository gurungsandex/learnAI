...
export default function MiniGameScreen() {
  ...
  function next() {
    ...
    const startedAt = Number(sessionStorage.getItem(`chapterStart_${chapter.id}`))
    if (startedAt && Date.now() - startedAt < 3 * 60 * 1000) earnBadge('speedrunner')
    sessionStorage.removeItem(`chapterStart_${chapter.id}`)
